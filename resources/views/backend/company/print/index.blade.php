...
<head>
    ...
    <title>SURAT PERMOHONAN IZIN PROMOSI EKRAF</title>
...
<body>
    <table width="100%">
        <tr>
            ...
            <td style="text-align:center; padding:0px" width="33%">
                ...
                <p class="mb-0" style="font-size: 14px;color:black">Jl. Mh. Thamrin, AJung Kulon, Kecamatan Ajung,
                    Jember 68175
                </p>
    ...
    <h5 style="font-weight: bold; font-size: 16px; margin-bottom: 0; text-align: center; margin-top: 30px;">Surat
        Permohonan Izin Promosi Ekraf
    </h5>
    <div style="margin-left: 30px; margin-right: 30px">
        <p style="font-size: 13px; margin-top: 60px;">Berikut dibawah ini merupakan Ekraf yang melakukan pendaftaran
            pada Website Promosi Ekraf Jember : </p>
                ...
                <tbody>
                    <tr>
                        @foreach ($data->attachment as $item)
                            <td>
                                <img src="{{ storage_path('app/public/images/companies/attachment/' . $item->name) }}"
