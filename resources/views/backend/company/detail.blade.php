...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="{{ route('apps.validations') }}" data-toggle="ajax">Validasi</a>
        </li>
...
@section('content')
    <div class="text-sm-end mb-3 text-center">
        <button class="btn btn-dark btn-sm" type="button" data-toggle="ajax"
            data-target="{{ route('apps.companies') }}">Kembali</button>
        <button class="btn btn-primary btn-sm" type="button" data-toggle="ajax"
            data-target="{{ route('apps.companies.edit', $data->hashid) }}"><i class="fas fa-edit"></i> Edit</button>
    </div>
    @if ($data->status == 'rejected')
        <div class="alert alert-info"><i class="fas fa-info-circle"></i> {{ $data->message_rejected }}</div>
    @endif
    <div class="row">
        <div class="col-lg-12">
                                    ...
                                    <div class="col-md-auto">
                                        <div class="avatar-md">
                                            <div class="avatar-xl avatar me-3 bg-white rounded-circle">
                                                <img src="{{ asset('storage/images/companies/logo/' . $data->logo) }}"
                                                    alt="" class="avatar-xs">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md">
                                        <div>
                                            ...
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <div class="vr"></div>
                                                <div><i class="fas fa-id-card-alt me-1"></i> {{ $data->haki_number ?? '-' }}
                                                </div>
                                                <div class="vr"></div>
                                                <div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h6 class="fs-15 mb-0">{!! $data->facebook_username != null
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h6 class="fs-15 mb-0">{!! $data->instagram_username != null
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h6 class="fs-15 mb-0">{!! $data->twitter_username != null
                                                ...
                                                <div class="col-lg-3 col-sm-6">
                                                    <div>
                                                        ...
                                                        <h6 class="fs-15 mb-0">
                                                            {{ $data->status == 'pending' ? 'Menunggu Diverifikasi' : ($data->status == 'approved' ? 'Terverifikasi' : 'Ditolak') }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-xxl-4 col-lg-6">
                                                        <div class="border rounded border-dashed p-2">
                                                            <div class="card h-100">
                                                                <img src="{{ asset('storage/images/companies/attachment/' . $item->name) }}"
                                                                    width="180px" height="180px" class="card-img-top"
                                                                    alt="...">
                                                            </div>
                                                        </div>
                                                    </div>
