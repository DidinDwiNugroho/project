    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
              <img class="img-responsive" src="{{ asset('assets1/img/logodepan.jfif') }}" alt="slider">
              <div class="slider-content">
                  <div class="col-md-12 text-center">
                      <h1 class="animated3">
                          <span><strong>Selamat Datang</strong> di Prokraf Banyuwangi</span>
                      </h1>
                      <p class="animated2">Pengembangan sistem informasi pemasaran ekonomi kreatif<br> untuk mengoptimalkan fleksibilitas <br> kreatifitas dan produktivitas</p>	
          ...
          <div class="carousel-item">
              <img class="img-responsive" src="{{ asset('assets1/img/logodepan2.jfif') }}" alt="slider">
              <div class="slider-content">
                  <div class="col-md-12 text-center">
                      <h1 class="animated2">
                          <span>Daftarkan Prokrafmu <strong>Sekarang</strong></span>
                      </h1>
                      <p class="animated1">Daftarkan dan promosikan usaha ekonomi kreatifmu secara resmi <br> di Dinas Pariwisata dan Kebudayaan Kabupaten Banyuwangi</p>	
                  </div>
              </div>
          </div>
          <!--/ Carousel item end -->
