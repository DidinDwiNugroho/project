...
<html lang="en">
  <head>
    ...
    <title>{{ $title }} | Ekraf Banyuwangi</title>
    <meta content="" name="description" />
    <meta content="" name="keywords" />

    <!-- Favicons -->
    <link href="{{ asset ('assets1/img/rsz_logobanyuwangi.png') }}" rel="icon" />
  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <h1 class="logo me-auto"><a href="{{ route('home') }}">PROKRAF BANYUWANGI</a></h1>
      ...
      <div class="container ">
          <div class="row">
              <div class="col-md-4">
                  ...
                  <img src="{{ asset('assets1/img/rsz_logobanyuwangi.png') }}" alt="">
              </div>
              <div class="col-md-4">
                  <h4 class="mt-4 fw-bold"><a href="{{ route('home') }}">www.ProkrafBanyuwangi.co.id</a></h4>
              </div>
          </div>
      </div>
    </footer>
